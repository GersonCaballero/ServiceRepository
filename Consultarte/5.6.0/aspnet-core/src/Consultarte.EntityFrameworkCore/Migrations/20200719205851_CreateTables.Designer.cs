...
namespace Consultarte.Migrations
{
    ...
    [Migration("20200719205851_CreateTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Consultarte.Features.FinalUsers.FinalUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Consultarte.Features.PaymentTypes.PaymentType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("ServiceProviderUserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Consultarte.Features.ServiceProviderUsers.ServiceProviderUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ServiceProviderUsers");
                });

            modelBuilder.Entity("Consultarte.Features.Services.Service", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Consultarte.Features.TypeServices.TypeService", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Consultarte.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Consultarte.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Consultarte.Features.PaymentTypes.PaymentType", b =>
                {
                    b.HasOne("Consultarte.Features.ServiceProviderUsers.ServiceProviderUser", "ServiceProviderUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Consultarte.Features.ServiceProviderUsers.ServiceProviderUser", b =>
                {
                    b.HasOne("Consultarte.Features.TypeServices.TypeService", "TypeService")
                        .WithMany()
